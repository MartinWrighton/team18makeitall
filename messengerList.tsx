...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className='w-screen h-screen pt-5 bg-gradient-to-bl from-slate-500 to-slate via-slate-200'>
        <div className='mx-auto p-5 bg-slate-to-bl from-slate-600 to-slate-500 via-slate-600 shadow-xl rounded-xl w-1/3 h-fit'>
          <h1 className='text-center font-bold font-sans text-5xl'>Messenger</h1>
        </div>
        <div className='relative mx-auto my-5 p-5 bg-gradient-to-bl shadow-xl rounded-xl w-8/12 h-5/6 space-y-5'>
