...
export default function Home() {
    ...
    await fetch(url, {
      ...
      .then((data) => {
        if ((data.data)) {
          ...
          if (bcrypt.compareSync(password, data.data.passhash)){
  ...
  function hashPassword(password: string){//only used to hash passwords when they are created, can be removed afterwards
      ...
      <div className='w-screen h-screen pt-5 bg-gradient-to-bl from-red-300 to-blue-300 via-purple-300'>
        ...
        <div className='mx-auto my-5 p-5 bg-gradient-to-bl from-red-500 to-blue-500 via-purple-500 shadow-xl rounded-xl w-8/12 h-5/6 space-y-5'>
          ...
          <div className='w-fit mx-auto space-y-5'>
            ...
            <br/>
            <input id="password"  placeholder='Password' className='justify-center border-2  rounded-md bg-gray-100' onInput={(e:any)=>{
